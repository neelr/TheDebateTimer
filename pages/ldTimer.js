...
export default class Index extends React.Component {
    ...
    componentDidMount() {
        ...
        Array.prototype.map.call(document.getElementsByClassName("four"),(element)=> {
            element.onclick = ()=>  {
                if (prep == 1) {
                    affPrep = time;
                } else if (prep == 2) {
        ...
        Array.prototype.map.call(document.getElementsByClassName("six"),(element)=> {
            element.onclick = ()=>  {
                if (prep == 1) {
                    affPrep = time;
                } else if (prep == 2) {
        ...
        Array.prototype.map.call(document.getElementsByClassName("seven"),(element)=> {
            element.onclick = ()=>  {
                if (prep == 1) {
                    affPrep = time;
                } else if (prep == 2) {
